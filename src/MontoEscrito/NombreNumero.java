...
public class NombreNumero {
	...
	public NombreNumero(int number) {
		super();
		// constructor stub
		this.Nombre(number);
	}
	...
	public String mult(int n) {
		...
		if (n == 0) {
			...
			r = this.num20(n % 10);
		} else if (n > 20 && n < 100 && Math.round(n % 10) == 0) {
			r = this.num20(n % 10);
		} else if (n > 20 && n < 100) {
			r = " Y " + this.num20(n % 10);
		} else if (n >= 100 && n < 1000 && n % 100 == 0) {
			r = "";
		} else if (n >= 100 && n < 1000 && Math.round(n % 100 / 10) == 0) {
			r = this.num100(n % 100);
		} else if (n >= 100 && n < 1000) {
			r = " " + this.num100(n % 100);
		} else if (n >= 1000 && n < 10000 && n % 1000 == 0) {
			r = "";
		} else if (n >= 1000 && n < 10000 && Math.round(n % 1000 / 100) == 0) {
